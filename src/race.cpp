...
static inline RACE_MANAGER* LOAD_COURSE()
{
...
static const S32* COURSE_NAME_SIZE()
{
	calloc(1, sizeof(COURSE_NAME));
	return;
}
...
static inline void GET_COURSE_NAME(RACE_MANAGER::RACE_INDEX INDEX, DISCORD_PRESENCE* PRESENCE)
{
	LOAD_COURSE();
	LOAD_CHARACTERS();
